...
## Vercel safety config in repo

This repo now includes a root `vercel.json` that forces Vercel to build the Next.js app from `frontend/package.json`.
This prevents accidental deployment of a default/starter app when project root settings are wrong.
